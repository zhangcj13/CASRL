...
os.environ['GYM_CONFIG_CLASS'] = 'TrainPhase_PPOS_STAGE2'
...
class Params():
    def __init__(self):
        ...
        self.lr = 2e-5# 4agents:  2e-4, 10agents: 2e-5
        ...
        self.pre_load_epoch=25000 # 4agents:  0, 10agents: 25000
...
def run(params, policy, optimizer, envs, policy_path,tb_writer):
    ...
    ampl2goal = 0.08 # 4agents:  params.ampl2goal[0], 10agents: 0.08
...
if __name__ == '__main__':
    ...
    log_dir ='runs/dppo_discrete_stage2/{}'.format(Config.ACT_ARCH)
    ...
    policy_path = 'weight/dppo_discrete_stage2/{}'.format(Config.ACT_ARCH)
    ...
    if params.pre_load_epoch>0:
        ...
        policy.load('weight/dppo_discrete_stage1/{}'.format(Config.ACT_ARCH), params.pre_load_epoch)
    else:
        print('#####################################')
